...
export default function ProfilePage() {
	...
	return (
		...
		>
			<AppHeader />
			<main
				style={{ maxWidth: 760, margin: "0 auto", padding: "16px 12px 28px" }}
			>
				<section
					style={{
				...
				>
					...
					<div
						style={{ color: "var(--muted)", fontSize: 13, marginBottom: 14 }}
					>
					...
					{error && (
						<div
							style={{ marginTop: 12, color: "var(--danger)", fontSize: 13 }}
						>
							{error}
						</div>
					)}
					{message && (
						<div
							style={{ marginTop: 12, color: "var(--success)", fontSize: 13 }}
						>
							{message}
						</div>
					)}
