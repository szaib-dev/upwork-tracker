...
import { HiOutlineClipboardDocument, HiOutlineGlobeAlt, HiOutlineLockClosed, HiOutlineShare, HiXMark } from "react-icons/hi2";
          ...
          <div style={modalStyle}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, marginBottom: 12 }}>
              <div>
                ...
                <div style={{ fontSize: 12, color: "var(--muted)", marginTop: 3 }}>Create public/private access link.</div>
              </div>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
                    {emails.map((email) => (
                      <span key={email} style={chipStyle}>
                        {email}
                        <button onClick={() => removeEmail(email)} style={chipCloseBtn} aria-label={`Remove ${email}`}>
                          <HiXMark />
                        </button>
                      </span>
                    ))}
                    <input
                      ...
                      placeholder={emails.length ? "Add more emails" : "Type email and press space"}
                      style={chipInput}
                    />
                  </div>
                </div>
